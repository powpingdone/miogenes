...
pub extern "C" fn drop_opaque_RwLockMioClientState(ptr: *const c_void) {
    unsafe {
        Arc::<RwLock<MioClientState>>::decrement_strong_count(ptr as _);
    }
}

#[no_mangle]
pub extern "C" fn share_opaque_RwLockMioClientState(ptr: *const c_void) -> *const c_void {
    unsafe {
        Arc::<RwLock<MioClientState>>::increment_strong_count(ptr as _);
        ptr
    }
}
...
pub struct wire_MioClient {
    field0: wire_RwLockMioClientState,
}
